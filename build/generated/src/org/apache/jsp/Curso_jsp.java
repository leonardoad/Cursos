...
//                conn = DriverManager.getConnection("localhost", "postgres", "senacrs");
                conn = DriverManager.getConnection("jdbc:postgresql://localhost:5432/cursos");

                String sql = "INSERT INTO professor (nome,email) values (?,?)";

                ps = conn.prepareStatement(sql);
                ps.setString(1, "Valdir");
                ps.setString(2, "valdir@gmail.com");
                System.out.print ("ok");
